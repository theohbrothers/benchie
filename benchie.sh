...
if [ "$1" = '--help' ] || [ "$1" = '-h' ] || [ "$1" = 'help' ]; then
    ...
    echo './benchie.sh start client-networking-latency'
    echo './benchie.sh start client-networking-latency homewifi'
    echo './benchie.sh start client-networking-latency hotspot'
    echo './benchie.sh start client-networking-latency wsgx'
    echo ''
    echo './benchie.sh status [benchmark]'
    echo '# Gets all the benchmark PIDs of client-networking-latency benchmark'
    echo './benchie.sh status client-networking-latency'
    echo ''
    echo './benchie.sh stop [benchmark]'
    echo '# Kills all the benchmark PIDs of client-networking-latency benchmark'
    echo './benchie.sh stop client-networking-latency'
    echo ''
    echo './benchie.sh clean [benchmark]'
    echo '# Cleans all the benchmark data folder client-networking-latency/data'
    echo './benchie.sh clean client-networking-latency'
    exit 0
fi
